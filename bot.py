...
async def help(ctx, *, pageString=''):
    ...
    helpEmbedTimerOne.add_field(name=commandPrefix + "log edit gameid summary", value="After a game a finished, the DM may edit the log and add a summary to the game in the session logs channel. After using this command to edit the log, the log will be checked and rewards will be given out.", inline=False)
